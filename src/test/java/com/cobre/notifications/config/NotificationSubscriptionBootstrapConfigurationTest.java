    ...
    void createsTheBootstrapAndBindsEventTypesWhenEnabled() {
        contextRunner
                ...
                .run(context -> {
                    ...
                    NotificationSubscriptionBootstrapProperties properties = context.getBean(
                            NotificationSubscriptionBootstrapProperties.class);
                    assertThat(properties.eventTypes())
